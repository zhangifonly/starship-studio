...
try {
  for (const [width, height] of [[1440, 1000], [390, 844]]) {
    ...
    for (const [camera, times] of [['cinematic', [0, 14, 18, 82, 86, 89]], ['ground', [0, 89]], ['booster', [89, 82, 0, 89]]]) {
    ...
    await expect.poll(async () => Number(await canvas.getAttribute('data-time'))).toBeGreaterThan(89.2);
